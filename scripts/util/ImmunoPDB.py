...
if __name__ == '__main__':
    ...
    parser.add_argument( '--scheme','-s', type=str, choices=["Chothia", "c"]+['pdb'], default="Chotia", help="Which numbering scheme should be used. c is shorthand for Chothia. Use pdb to retain the numbering but get the annotations as remarks", dest="scheme")
